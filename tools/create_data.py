...
if __name__ == '__main__':
    my_root_path = "/home/ch511/mmdet_dataset/KITTI"
    create_kitti_info_file(my_root_path)
    create_reduced_point_cloud(my_root_path)

    create_groundtruth_database(data_path=my_root_path, \
                                info_path=osp.join(my_root_path, "kitti_infos_trainval.pkl"), \
                                db_info_save_path=osp.join(my_root_path, "kitti_dbinfos_trainval.pkl"))